#!/usr/bin/env python
# -*- coding:utf-8 -*-  
# @Time    : 2017/6/26 09:47
# @Author  : CGX

#提供几个目录把这几个目录中的文件都打到一个zip中

import zipfile
import os

# dirName = '/eyuroot/ngp/gen/NgpDex/src'
dirName = '/Users/cuangengxuan/Desktop/my'
dirName2 = ''
zipName = '/Users/cuangengxuan/Desktop/test.jar'

def func():
    dirList = [dirName, dirName2]
    zip_dir(dirList, zipName)


# 压缩
def zip_dir(dirList, zipfilename):
